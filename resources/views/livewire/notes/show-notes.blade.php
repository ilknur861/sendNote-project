                    ...
                    <x-card wire:key="{{ $note->id }}" class="mt-4">
                        <div class="flex justify-between">
                            ...
                            <div class="text-xs text-gray-500">
                                ...
                                <div>
                                    <x-badge flat primary label="unpublished">
                        ...
                        <div>
                            <x-mini-button rounded white icon="eye" href="{{ route('notes.show',$note) }}"
                                           wire:navigate></x-mini-button>
                            <x-mini-button wire:click="delete('{{$note->id}}')" rounded icon="trash" flat gray
                                           interaction="negative"  wire:confirm="Are you sure you want to delete this post?"
                            />
                        </div>
                    </x-card>
                @endforeach
